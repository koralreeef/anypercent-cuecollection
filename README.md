...
## Old Site
 ...
 <img src="https://github.com/koralreeef/cuedump-anypercent/blob/main/images/2start4.webp" width="384" height="216"/>
   ...
   \
   upleft dashing between these two blue lines guarantees madelines y-position always being in the dream block after the cutscene skip.
   </details>
   ...
   \
   enter on right side of transition, hold up and right and buffer all three diagonal dashes and you wont ever die.
   </details>
 ...
 <img src="https://github.com/koralreeef/cuedump-anypercent/blob/main/images/intervention4.webp" width="384" height="216"/>
  ...
  <details>
   ...
   \
   this neutral kick is extremely feel based and hard to get down at first, but this cue might help for getting muscle memory on the right track. it also helps to get to the left side of the coin block asap as its activating.
   </details>
   ...
   \
   this is the correct height needed to get the downright cb, noted by madeline lining up with the pink space pixels. if you arent lined up, back this up with an upright dash to    get to the platform. you will die or lose more time otherwise.
   </details>
...
## Celestial Resort
 ...
 <details>
   ...
   \
   the upleft wallkick helps to ensure you dont go too fast, and downleft dashing on this cue and only holding left allwows you drift into the key. after landing, do a neutral walljump into a downleft > down > downright dash.
   \
   ![cue](https://cdn.discordapp.com/attachments/293555577991200770/775576485280874546/unknown.png)
   \
   hold fastfall and demo at or above the height of this clock, and you should have achieved the fast key.
 </details>
 ...
 <details>
   ...
   \
   for this strat, a common mistake is buffering demos which you cant do. be sure to demo at the height of your super and not buffer it.
 </details>
 ...
 <details>
  ...
  <details>
   ...
   \
   this strat is kinda dumb but theres good cues. downleft dash after max height hyper bhop and upright dash between the two lines highlighted. if you need another cue for learning, the end of the window is a good place to look for timing the downleft.
 </details>
  ...
  <details>
   ...
   \
   when leaving 10-c, be sure to hold jump and buffer a downright dash to get a bhop and dodge the cycle. to make the fast cycle in 12-d, wallbounce in the previous room pictured before entering to gain more height. the fast cycle is more managable with this extra boost.
 </details>
 ...
 <details>
  ...
  <details>
   ...
   \
   bonus cue for this coyote super that i dislike very much, jump on this skull and you shouldnt die. for the turnaround corner grab, try to use a crouched jump and press jump + right at the same time.
 ...
 <details>
  ...
  <details>
   ...
   \
   hit the middle/right side of the spring, and be close to this column of dust bunnies before dashing for clean landing and skipping sprng hit + downdash.
 </details>
